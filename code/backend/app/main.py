...
or shared helpers from ``app.main``.
"""
...
from .routers import agents, azure, generation, ops, rag, tools
...
from .routers.azure import azure_status
from .routers.generation import ask
from .routers.ops import config, health
...
from .routers.tools import speak, transcribe, web_fetch
