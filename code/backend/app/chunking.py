"""Stable facade and dispatcher for all chunking strategies.

Basic algorithms live in ``chunking_core``; Markdown hierarchy handling lives
in ``chunking_markdown``. Existing imports from ``app.chunking`` remain valid.
"""
