...
"""Invoke the hosted Foundry agent directly — no FastAPI in the way.
    ...
    .venv/Scripts/python.exe scripts/invoke_agent.py "Why was my card blocked?"
    .venv/Scripts/python.exe scripts/invoke_agent.py "Why was my card blocked?" --persona lyrical
...
from backend.agents.foundry_agent import FoundryUnavailable, run  # noqa: E402
from backend.agents.persona import PersonaNotFound, load_persona  # noqa: E402
