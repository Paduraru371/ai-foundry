...
Write-Host "`n─── put this in .env ───────────────────────────────" -ForegroundColor Cyan
@"
LLM_PROVIDER=azure
...
Write-Host "Verify with:  .venv/Scripts/python.exe docs/examples/02_hello_foundry.py" -ForegroundColor Green
