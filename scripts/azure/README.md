...
| Shell | Python |
|---|---|
| `03-create-agent` | `.venv/Scripts/python.exe scripts/deploy_agent.py <persona>` |
| `04-invoke-agent` | `.venv/Scripts/python.exe scripts/invoke_agent.py "question"` |
| `05-inspect` | `.venv/Scripts/python.exe docs/examples/09_list_deployments.py` |
