...
to end without FastAPI in the way. Needs Qdrant: docker compose up qdrant -d
    ...
    .venv/Scripts/python.exe docs/examples/11_rag_pipeline.py
"""
from __future__ import annotations

from _bootstrap import banner, show_context
from backend.agents import load_persona
from backend.agents.local_agent import run as run_agent
