...
backend/agents/personas/ and re-run to see the effect immediately.

    .venv/Scripts/python.exe docs/examples/10_agent_local.py
    .venv/Scripts/python.exe docs/examples/10_agent_local.py "Why was my card blocked?"
"""
...
from backend.agents import list_personas
from backend.agents.local_agent import run
